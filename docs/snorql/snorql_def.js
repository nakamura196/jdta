...
var Snorqldef = {
	...
	vars: {
		...
		_endpoint: "https://dydra.com/ut-digital-archives/jdta/sparql",
		_poweredByLink: "https://www.enpaku-jdta.jp/",
		_poweredByLabel: "JAPAN DIGITAL THEATRE ARCHIVES",
	...
	home: {
    	label: "JAPAN DIGITAL THEATRE ARCHIVES",
		uri: "https://github.com/ut-digital-archives/jdta",
...
Snorqldef.example = [
	{
		"label": "dcepk:Agent",
		"label_en" : "dcepk:Agent",
		"ns" : [ ],
		"query" : "SELECT DISTINCT * \nWHERE {\n	?s a dcepk:Agent; dct:title ?label . \n}\nLIMIT 100"
	},
	{
		"label": "タイプ別アイテム数",
		"label_en" : "タイプ別アイテム数",
		"ns" : [ ],
		"query" : "SELECT DISTINCT (count(?s) as ?count) ?type \nWHERE {\n	?s a ?type\n}\nGROUP BY ?type\nORDER BY desc(?count)"
	}
